import os
import torch
from dran import main
from torch.autograd import Variable
from dataLoader import SalObjDataset, ToTensorLab, RescaleT
from dran_test import test
...
cosinelr = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=150000, eta_min=0)
