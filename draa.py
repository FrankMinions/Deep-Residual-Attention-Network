...
class DRAA(nn.Module):
    def __init__(self):
        super(DRAA, self).__init__()
        self.pool = nn.MaxPool2d(2, stride=2, ceil_mode=True)  # downsampling
    ...
    def forward(self, x):
        ...
        hx1 = nn.ReLU(inplace=True)(hx1r3 + hx1)
        ...
        hx2 = nn.ReLU(inplace=True)(hx2r3 + hx2)
        ...
        hx3 = nn.ReLU(inplace=True)(hx3r3 + hx3)
        ...
        hx4 = nn.ReLU(inplace=True)(hx4r3 + hx4)
        ...
        hx5 = nn.ReLU(inplace=True)(hx5r3 + hx5)
        ...
        hx6 = nn.ReLU(inplace=True)(hx6r3 + hx6)

        hx7 = self.encoconv7(hx6)
